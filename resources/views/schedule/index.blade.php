                        ...
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <td class="px-5 py-4">
                                <div class="flex gap-3 items-center">
                                    @if($jadwal->payment_status === 'paid')
                                        <a href="{{ route('schedule.invoice', $jadwal->id) }}" target="_blank" class="text-sm font-medium text-blue-600 hover:text-blue-800 transition-colors bg-blue-50 px-3 py-1 rounded-md">Cetak Bukti Peembayaran</a>
